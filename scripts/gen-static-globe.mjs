...
// Zaokrąglamy do liczb całkowitych. Przy SIZE 1000 (viewBox) krok = 1 jednostka
// ≈ ~1px przy wyświetlaniu → gładkie krawędzie krajów (bez kanciastości jak przy
// SIZE 300), a integer trzyma rozmiar w ryzach.
