      ...
      <div className="border-t border-white/10">
        <div className="flex items-center justify-between px-[5vw] py-12">
          ...
          <div className="flex gap-12">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm m-0 mb-1">ul. Przykladowa 10</p>
              <p className="text-white/80 text-sm m-0">00-001 Warszawa</p>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-between px-[5vw] py-4 border-t border-white/5">
          ...
          <div className="flex gap-6">
            <a href="#" className="text-white/30 text-xs no-underline hover:text-white/60 transition-colors">Polityka prywatnosci</a>
            <a href="#" className="text-white/30 text-xs no-underline hover:text-white/60 transition-colors">Regulamin</a>
          </div>
        </div>
      </div>
    </footer>
